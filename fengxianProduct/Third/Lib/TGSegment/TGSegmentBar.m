...
//        UIImage *hideImage = [UIImage imageWithContentsOfFile:hideImgPath];
        ...
        UIImage * showImage = [UIImage imageNamed:@"MoreColumn_Icon"];//threeColumn_open_icon//Profile_filter_downClick
...
//        [self hidePanel];
//    }
    [[NSNotificationCenter defaultCenter]postNotificationName:@"NewsMoreBtnClick" object:nil];
